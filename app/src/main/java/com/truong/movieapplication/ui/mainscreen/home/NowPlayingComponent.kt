...
class NowPlayingComponent : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fragmentTitle.text = getString(R.string.now_playing_label)
        ...
        mainViewModel.nowPlayingMovies.observe(viewLifecycleOwner) { movies ->
    ...
    companion object {
        fun newInstance() = NowPlayingComponent()
    }
}